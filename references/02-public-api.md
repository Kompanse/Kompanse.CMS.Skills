...
| `GET /api/public/product-catalog/products` | Lists products | `page`, `pageSize`, `categoryId`, `search`, `lang`, `attrs[code]`, `attrs[code_min]`, `attrs[code_max]` |
...
const products = await fetch(
  '/api/public/product-catalog/products?categoryId=xxx&attrs[color]=Blue&lang=en',
  {
